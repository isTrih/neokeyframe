...
// endregion
// region 注册编辑器
const {EditorTemp} =storeToRefs(useEditorStore())
const editor = useEditor({
  ...
  editable: true,
  onUpdate: ({ editor }) => {
    EditorTemp.value = editor.getHTML()
...
.bilibili-wrapper.ProseMirror-selectednode {
...
.tiptap [data-type="emoji"] img.ProseMirror-selectednode {
  border-top: 1px solid var(--czjP-5);
}
